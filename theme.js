...
jQuery(function() {
    ...
    jQuery(document).on('fscreenchange', function(e, state, elem) {
        if (jQuery.fullscreen.isFullScreen()) {} else {
...
jQuery(document).ready(function() {
    if (jQuery('.fadeOnLoad').length) {
        if (jQuery('.aurel_preloader_wrapper').length) {} else {
    ...
    jQuery('.aurel_albums_masonry_page').each(function() {
        ...
        var items_set = [{
            category_class: 'food-drink',
            src: 'https://i1.wp.com/celebrity.ohfree.net/wp-content/uploads/2017/09/Natural-breasted-vintage-Indian-Maya-Singh-010-by-sexvcl.net_.jpg?resize=1701%2C2340&ssl=1',
            album_href: 'album_slider.html',
            category_name: 'food+drink',
            title: 'Autumn Evening'
        }, {
            category_class: 'portraits',
            src: 'https://i0.wp.com/celebrity.ohfree.net/wp-content/uploads/2017/09/Natural-breasted-vintage-Indian-Maya-Singh-013-by-sexvcl.net_.jpg?resize=578%2C511&ssl=1',
            album_href: 'album_split.html',
            category_name: 'portraits',
            title: 'Business Style'
        },  {
            category_class: 'food-drink',
            src: 'http://sexsagar.net/wp-content/uploads/2016/01/mast-mamme-close-look-desi-indian-girl-nude-outdoor-xxx-sex-pic.jpg',
            album_href: 'album_slider.html',
            category_name: 'food-drink',
            title: 'Breakfast'
        },  {
            category_class: 'food-drink',
            src: 'https://img-hw.xvideos.com/videos/profiles/galleries/69/c1/23/lovedarkdesiwomen/gal1162813/pic_123_big.jpg',
            album_href: 'album_slider.html',
            category_name: 'food-drink',
            title: 'Breakfast'
        }];
